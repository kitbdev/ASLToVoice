...
//    public static boolean RecordTrain(String sign) throws InterruptedException, IOException {
//        
//        if (!connected) {
...
//        System.out.println(allSigns.get(lastSign).frames.get(lastSignLastFrame).handRot.x);
    ...
    public static boolean RecordTest() throws InterruptedException, IOException {
//        if (!connected) {
//            System.out.println("Connect to a leap sensor first!");
//            return "";
//        }
        ...
        if (curSign.frames.size() < curSign.normalizedNumFrames) {
            ...
            signName = "ERROR: Not enough frames";
            //getSignName("ERROR: Not enough frames");
            return true;
        }
